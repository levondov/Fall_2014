...
x1,y1=np.genfromtxt("Section-103-James_Tensile-Test-1018mildsteel.txt", unpack=True, skiprows = 1)
x2,y2=np.genfromtxt("Section-103-James_Tensile-Test-4340.txt", unpack=True, skiprows = 1)
x3,y3=np.genfromtxt("Section-103-James_Tensile-Test-Al-Cu.txt", unpack=True, skiprows = 1)

y1e = y1/(np.pi*(0.241)/4)
y2e = y2/(np.pi*(0.230)/4)
y3e = y3/(np.pi*(0.235)/4)
x1e = x1/1.898
x2e = x2/1.891
x3e = x3/2.134
