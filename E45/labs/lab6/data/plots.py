...
x=.1/(temp_semi + 273)
y=np.log(1/resist_semi)

slope, intercept, r_value, p_value, std_err = stats.linregress(x,y)
print(slope, intercept, r_value, p_value, std_err)

#(-30474.367134980825, 9.3714563026627591, -0.98639798755030872, 2.2916539659741053e-08, 1692.7623085578143)
...
print(slope1/1.38e-23)
E = slope1/1.38e-23
print(-2*(slope2*1.38e-23+E))
