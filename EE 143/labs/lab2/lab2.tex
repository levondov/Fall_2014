...
\end{tikzpicture}
\caption{Test 2 for Mosfet 9a. On the right side we did a linear regression on the V SB = 0 line in order to get a estimate of the threshold voltage.}
\label{fig:9alin}
\end{figure}
...
\end{tikzpicture}
\caption{Test 2 for Mosfet 9b. On the right side we did a linear regression on the V SB = 0 line in order to get a estimate of the threshold voltage.}
\label{fig:9blin}
\end{figure}
...
\end{tikzpicture}
\caption{Test 2 for Mosfet 9c. On the right side we did a linear regression on the V SB = 0 line in order to get a estimate of the threshold voltage.}
\label{fig:9clin}
\end{figure}
