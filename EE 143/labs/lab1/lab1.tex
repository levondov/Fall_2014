...
\centering
\begin{tabular}{c || c | c }
Layer & \specialcell{Sheet Resistance \\ ($\Omega$/sqr)} & \specialcell{Surface concentration \\ (??)} \\ \hline

\specialcell{ACTV after \\ Field Oxidation} & 530 & ? \\ \hline
Polysilicon & ? & ? \\ \hline
\specialcell{ACTV after \\ Pre-Dep} & 5 & ? \\ \hline
\specialcell{ACTV after \\ Drive-In} & 8 & ? \\ \hline
Metal & ? & ? \\ \hline
