...
int main () {
    ...
    cout << "Should get operator= call here deleting elements of list 1." << endl;
    list1 = list2;
    cout << "List 1 after replacement:" << endl;
    iter = new SortedListIterator<int> (list1);
    while (iter->MoreRemain ()) {
	cout << " " << iter->Next ();
    }
    ...
    cout << "Error msg should result here from assigning list 2 to itself."
	 << endl;
    list2 = list2;
